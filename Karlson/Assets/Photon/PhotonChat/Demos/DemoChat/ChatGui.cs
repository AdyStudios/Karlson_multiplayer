...
namespace Photon.Chat.Demo
{
    ...
    public class ChatGui : MonoBehaviour, IChatClientListener
    {
        ...
        private void SendChatMessage(string inputLine)
        {
            ...
            //UnityEngine.UnityEngine.UnityEngine.Debug.Log("selectedChannelName: " + selectedChannelName + " doingPrivateChat: " + doingPrivateChat + " privateChatTarget: " + privateChatTarget);
            ...
            if (inputLine[0].Equals('\\'))
            {
                ...
                {
                    UnityEngine.Debug.Log("The command '" + tokens[0] + "' is invalid.");
                }
            }
            else
            {
        ...
        public void OnUnsubscribed(string[] channels)
        {
            foreach (string channelName in channels)
            {
                if (this.channelToggles.ContainsKey(channelName))
                {
                    ...
                    UnityEngine.Debug.Log("Unsubscribed from channel '" + channelName + "'.");
                ...
                {
                    UnityEngine.Debug.Log("Can't unsubscribe from channel '" + channelName + "' because you are currently not subscribed to it.");
                }
            }
        }
        ...
        public void OnPrivateMessage(string sender, object message, string channelName)
        {
            ...
            if (msgBytes != null)
            {
               UnityEngine.Debug.Log("Message with byte[].Length: "+ msgBytes.Length);
            }
